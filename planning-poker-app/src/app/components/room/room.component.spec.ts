...
@Component({
  ...
  template: '<div data-testid="poker-card"></div>'
})
class MockPokerCardComponent {
  @Input() value: Card = '?';
...
describe('RoomComponent', () => {
    ...
    beforeEach(async () => {
      ...
      .overrideComponent(RoomComponent, {
        remove: { imports: [PokerTableComponent, PokerCardComponent] },
        add: { imports: [MockPokerTableComponent, MockPokerCardComponent] }
      })
            .compileComponents();
    ...
    it('should render the correct number of card options', () => {
      const cardElements = fixture.debugElement.queryAll(By.directive(MockPokerCardComponent));
